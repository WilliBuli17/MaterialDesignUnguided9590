...
//data get from http://www.recipepuppy.com/api/?i=onions,garlic&q=omelet&p=3 , thank you.
public class Receipt {
    ...
    //Jawaban :
    // construtor pertama : cuma construtor kosong untuk inisialisasi
    //construtor kedua : mempersiapkan data untuk objek yang berada di dalamnya
    public Receipt() {
    }
