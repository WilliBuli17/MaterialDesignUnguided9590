...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkedFloatBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                checked = recyclerViewAdapter.returnCheckedRecipt();
                if (checked.isEmpty()){
    ...
    public  void showSimpleDialog(){
        CharSequence[] charSequences = getStringArray(checked);
        String simpleDialog = "";
        AlertDialog.Builder builder = new AlertDialog.Builder(MainActivity.this);
        for(int i = 0; i < checked.size(); i++) {
            simpleDialog = simpleDialog + "\n" + charSequences[i];
        }
        builder.setTitle("Checked Receipt!");
        builder.setMessage(simpleDialog);
    ...
    //Jawaban :
    //Mengambil nilai yang diimputkan user kedalam variabel dengan tipe data string biasa
    //lalu memasukkannya kedalam string array.
