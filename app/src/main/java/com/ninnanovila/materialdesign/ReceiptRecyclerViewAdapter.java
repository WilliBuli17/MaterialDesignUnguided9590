...
public class ReceiptRecyclerViewAdapter extends RecyclerView.Adapter<ReceiptRecyclerViewAdapter.ReceiptViewHolder> {
    ...
    public  List<String> returnCheckedRecipt(){
        return checked;
    }
    ...
    public void onBindViewHolder(@NonNull final ReceiptViewHolder holder, final int position) {
        ...
        holder.itemCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                addAndRemove(holder, v, holder.getAdapterPosition());
            }
        });
    }
    ...
    public void addAndRemove(ReceiptViewHolder holder, View view, int x){
        if(holder.itemCard.isChecked()){
            checked.add(receipts[x].getTitle());
            Toast.makeText(view.getContext(),
                    "Input : " + receipts[x].getTitle(),
                    Toast.LENGTH_SHORT).show();
        } else{
          checked.remove(receipts[x].getTitle());
          Toast.makeText(view.getContext(),
                  "Delete : " + receipts[x].getTitle(),
                  Toast.LENGTH_SHORT).show();
        }
    }
